    ...
    return (
        <div className="flex my-10 mx-10 items-center justify-start bg-white">
            <div className="mx-auto w-full max-w-lg">
                <p className="mt-3">Pour vous aider au mieux, donner un maximum d'information sur la prestation souhaitée</p>

                <form action="https://api.web3forms.com/submit" method="POST" className="mt-10">

                    <input type="hidden" name="access_key" value="2fd6c06e-3b43-42c2-8e1f-42d95b1589aa" />
                    <div className="grid gap-6 sm:grid-cols-2">
                        <div className="relative z-0">
                            ...
                            <label className="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-blue-600 peer-focus:dark:text-blue-500">Nom et prénom</label>
                        </div>
                        <div className="relative z-0">
                    ...
                    <button type="submit" className="mt-5 rounded-md bg-black px-10 py-2 text-white">Envoyer</button>
                </form>
            </div>
        </div>
    );
