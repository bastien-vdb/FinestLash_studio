...
const Techniques = ({presta, title, descr, img, price, link, complements, setPayClicked }) => {
        ...
        <>
            <div className="bg-gray-50 shadow-2xl rounded-lg py-4 flex flex-col justify-between items-center">
                <div className='h-full'>
                    <p className="text-xl text-center font-bold text-[#EBACA2]">{presta.title}</p>
                    <p className='my-6 mx-10 text-justify'>{presta.content}</p>
                </div>
                ...
                <p className="text-center py-8">
                    <span className="text-3xl font-bold text-[#EBACA2]">{presta.price}</span>
