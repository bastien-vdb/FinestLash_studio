export default function HyperUIButton() {
  return (
    <div className="flex justify-center items-center cursor-pointer">
      <a className="group flex items-center justify-between gap-4 rounded-lg border border-red-600 bg-red-600 px-5 py-3 transition-colors hover:bg-transparent focus:outline-none focus:ring">
        <span className="font-medium text-white transition-colors group-hover:text-red-600 group-active:text-red-600">Règlement intérieur de Finest Lash Studio</span>
