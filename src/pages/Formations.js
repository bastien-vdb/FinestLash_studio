    ...
    <>
      <div data-aos="zoom-in" className="bg-red-50 pb-10">
        ...
        <div className="container relative grid grid-cols-2 lg:w-[1000px] m-auto rounded shadow-lg">
          ...
          <Image data-aos="zoom-in" className="opacity-90 sm:h-[500px] shadow-lg object-cover border-2 col-span-2" src="/images/vignettes/vignette4.jpg" width={1366} height={1366} alt="Formation finest Studio" />
          <div className="image-overlay">
            <div className="overlay-text flex flex-col items-center justify-center gap-6">
              ...
              <h2 className="mx-6 text-3xl text-center text-white md:mx-12 lg:mx-40 lg:text-5xl">Les formations du Finest Lash Studio</h2>
            </div>
          </div>
        </div>
