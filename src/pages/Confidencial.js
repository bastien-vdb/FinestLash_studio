...
function Confidencial(props) {
    return (
        <div>
            <h2>Politique de confidentialité</h2>
            <div className='flex flex-col gap-4 text-justify my-4 mx-8 md:mx-20 lg:mx-40 xl:mx-60'>
                <h3>Qui sommes-nous ?</h3>
                <p>
                    L’adresse de notre site Web est : http://phoenixpermis.fr.
                </p>

                <h3 className='text-red-300'>Utilisation des données personnelles collectées</h3>
                <h3>Commentaires</h3>
                <p>
